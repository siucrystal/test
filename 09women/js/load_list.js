...
const M_LIST = [
    ...
    // new arrivals 1
    [
        {cate_no:1, item_no: 1, item_title:'리 블랑 노쿠 굿위드 65126', o_price:'55,000', s_price:'50,800', color:['mint','red', 'black'],src:'1.gif'},
        {cate_no:1, item_no: 2, item_title:'변트리 나염 루즈핏 65025', o_price:'23,000', s_price:'21,700', color:['white','yellogreen', 'black'],src:'2.gif'},
        {cate_no:1, item_no: 3, item_title:'해펀턴 시어서커 파자마 65037', o_price:'35,400', s_price:'32,300', color:['yag_green', 'purple'],src:'3.gif'},
        {cate_no:1, item_no: 4, item_title:'코로 버튼 5부 65128', o_price:'37,500', s_price:'34,200', color:['skyblue'],src:'4.gif'},
        {cate_no:1, item_no: 5, item_title:'뷔스티에 65149', o_price:'27,000', s_price:'24,600', color:['white', 'yag_green', 'black'],src:'5.gif'},
        {cate_no:1, item_no: 6, item_title:'단즈홀 겹 루즈 핏 65109', o_price:'59,900', s_price:'54,600', color:['base', 'black'],src:'6.gif'},
        {cate_no:1, item_no: 7, item_title:'유레이 버튼 린넨 롱 65063', o_price:'30,000', s_price:'27,100', color:['base','brown', 'black'],src:'7.gif'},
        {cate_no:1, item_no: 8, item_title:'모리나 유브이넥 모달 65001', o_price:'17,400', s_price:'15,900', color:['base', 'mint', 'black'],src:'8.gif'},
        ...
        {cate_no:1, item_no: 11, item_title:'반팔 듀린 린드 65125', o_price:'49,000', s_price:'44,600', color:['base', 'black'],src:'11.gif'},
        {cate_no:1, item_no: 12, item_title:'텔디 플라워 모델 통통 64989', o_price:'39,900', s_price:'36,400', color:['base', 'black'],src:'12.gif'},
        {cate_no:1, item_no: 13, item_title:'카미유 버튼발발 65059', o_price:'39,900', s_price:'36,400', color:['mint', 'black'],src:'13.gif'},
        {cate_no:1, item_no: 14, item_title:'땡 떙 떙 떙 59491', o_price:'34,000', s_price:'31,700', color:['blue'],src:'14.gif'},
        {cate_no:1, item_no: 15, item_title:'톰빔 플레어롱 65003', o_price:'24,000', s_price:'21,900', color:['base',"green",'black'],src:'15.gif'},
        {cate_no:1, item_no: 16, item_title:'율아뒤트임 0.6511', o_price:'32,000', s_price:'29,200', color:['base','black'],src:'16.gif'},
        {cate_no:1, item_no: 17, item_title:'리 블랑 노쿠 굿위드 65126', o_price:'55,000', s_price:'50,800', color:['mint','red', 'black'],src:'17.gif'},
        {cate_no:1, item_no: 18, item_title:'변트리 나염 루즈핏 65025', o_price:'23,000', s_price:'21,700', color:['white','yellogreen', 'black'],src:'18.gif'},
        {cate_no:1, item_no: 19, item_title:'해펀턴 시어서커 파자마 65037', o_price:'35,400', s_price:'32,300', color:['yag_green', 'purple'],src:'19.gif'},
        {cate_no:1, item_no: 20, item_title:'코로 버튼 5부 65128', o_price:'37,500', s_price:'34,200', color:['skyblue'],src:'20.gif'},
        {cate_no:1, item_no: 21, item_title:'뷔스티에 65149', o_price:'27,000', s_price:'24,600', color:['white', 'yag_green', 'black'],src:'21.gif'},
        {cate_no:1, item_no: 22, item_title:'단즈홀 겹 루즈 핏 65109', o_price:'59,900', s_price:'54,600', color:['base', 'black'],src:'22.gif'},
        {cate_no:1, item_no: 23, item_title:'유레이 버튼 린넨 롱 65063', o_price:'30,000', s_price:'27,100', color:['base','brown', 'black'],src:'23.gif'},
        {cate_no:1, item_no: 24, item_title:'모리나 유브이넥 모달 65001', o_price:'17,400', s_price:'15,900', color:['base', 'mint', 'black'],src:'24.gif'},
        ...
        {cate_no:1, item_no: 27, item_title:'반팔 듀린 린드 65125', o_price:'49,000', s_price:'44,600', color:['base', 'black'],src:'27.gif'},
        {cate_no:1, item_no: 28, item_title:'텔디 플라워 모델 통통 64989', o_price:'39,900', s_price:'36,400', color:['base', 'black'],src:'28.gif'},
        {cate_no:1, item_no: 29, item_title:'카미유 버튼발발 65059', o_price:'39,900', s_price:'36,400', color:['mint', 'black'],src:'29.gif'},
